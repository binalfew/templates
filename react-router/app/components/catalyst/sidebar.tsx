...
export function SidebarHeader({
	...
	return (
		<div
			...
			className={clsx(
				className,
				'border-border flex flex-col border-b p-4 [&>[data-slot=section]+[data-slot=section]]:mt-2.5',
			)}
		/>
	)
}
...
export function SidebarFooter({
	...
	return (
		<div
			...
			className={clsx(
				className,
				'border-border flex flex-col border-t p-4 [&>[data-slot=section]+[data-slot=section]]:mt-2.5',
			)}
		/>
	)
}
...
export function SidebarDivider({
	...
	return (
		<hr
			{...props}
			className={clsx(className, 'border-border my-4 border-t lg:-mx-4')}
		/>
	)
}
		...
		<span className={clsx(className, 'relative')}>
			{current && (
				<motion.span
					...
					className="bg-primary absolute inset-y-2 -left-4 w-0.5 rounded-full"
				/>
			)}
