      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 mb-6 dark:border-amber-900 dark:bg-amber-950">
          ...
          <p className="text-sm text-amber-800 dark:text-amber-200">
            Your organization requires two-factor authentication. Please complete the setup below to
            continue.
          </p>
        </div>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3 rounded-lg border bg-muted/50 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              After adding the account, your authenticator app will show a 6-digit code that changes
              every 30 seconds. Enter the current code below.
            </p>
          </div>
