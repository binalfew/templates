...
describe("broadcasts.server", () => {
  ...
  describe("listBroadcastsPaginated", () => {
    it("returns paginated items and totalCount", async () => {
      const { listBroadcastsPaginated } = await import("../broadcasts.server");
  ...
  describe("listBroadcasts", () => {
    it("lists broadcasts with defaults", async () => {
      const { listBroadcasts } = await import("../broadcasts.server");
  ...
  describe("getBroadcast", () => {
    it("returns broadcast with delivery stats", async () => {
      const { getBroadcast } = await import("../broadcasts.server");
    ...
    it("throws BroadcastError when not found", async () => {
      const { getBroadcast, BroadcastError } = await import("../broadcasts.server");
  ...
  describe("getBroadcastDeliveries", () => {
    it("returns paginated deliveries for a broadcast", async () => {
      const { getBroadcastDeliveries } = await import("../broadcasts.server");
    ...
    it("throws BroadcastError when broadcast not found", async () => {
      const { getBroadcastDeliveries, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("getBroadcastWithCounts", () => {
    it("returns broadcast with delivery count", async () => {
      const { getBroadcastWithCounts } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue({
        ...baseBroadcast,
        template: { name: "Welcome" },
    ...
    it("throws BroadcastError when not found", async () => {
      const { getBroadcastWithCounts, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("updateBroadcast", () => {
    it("updates a draft broadcast", async () => {
      const { updateBroadcast } = await import("../broadcasts.server");
    ...
    it("throws BroadcastError when broadcast not found", async () => {
      const { updateBroadcast, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("deleteBroadcast", () => {
    it("deletes a draft broadcast and its deliveries", async () => {
      const { deleteBroadcast } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue({ ...baseBroadcast, status: "DRAFT" });
    ...
    it("throws BroadcastError when broadcast not found", async () => {
      const { deleteBroadcast, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("sendBroadcast", () => {
    ...
    it("throws BroadcastError when broadcast not found", async () => {
      const { sendBroadcast, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("cancelBroadcast", () => {
    ...
    it("throws BroadcastError when broadcast not found", async () => {
      const { cancelBroadcast, BroadcastError } = await import("../broadcasts.server");
      mockBroadcastFindFirst.mockResolvedValue(null);
  ...
  describe("BroadcastError", () => {
    it("has correct default properties", async () => {
      const { BroadcastError } = await import("../broadcasts.server");
