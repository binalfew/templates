...
describe("permissions.server", () => {
  ...
  describe("listPermissions", () => {
    it("lists permissions with default ordering", async () => {
      const { listPermissions } = await import("../permissions.server");
  ...
  describe("listPermissionsPaginated", () => {
    it("returns paginated results with default ordering", async () => {
      const { listPermissionsPaginated } = await import("../permissions.server");
  ...
  describe("getPermission", () => {
    it("returns a permission by id", async () => {
      const { getPermission } = await import("../permissions.server");
    ...
    it("throws PermissionError when not found", async () => {
      const { getPermission, PermissionError } = await import("../permissions.server");
  ...
  describe("getPermissionWithCounts", () => {
    it("returns a permission with role counts and role details", async () => {
      const { getPermissionWithCounts } = await import("../permissions.server");
  ...
  describe("createPermission", () => {
    it("creates a permission and logs an audit entry", async () => {
      const { createPermission } = await import("../permissions.server");
    ...
    it("throws PermissionError on duplicate resource+action (P2002)", async () => {
      const { createPermission, PermissionError } = await import("../permissions.server");
  ...
  describe("updatePermission", () => {
    it("updates a permission description and logs audit", async () => {
      const { updatePermission } = await import("../permissions.server");
    ...
    it("throws PermissionError when permission not found", async () => {
      const { updatePermission, PermissionError } = await import("../permissions.server");
      mockPermissionFindFirst.mockResolvedValue(null);
  ...
  describe("deletePermission", () => {
    it("deletes a permission with no role assignments and logs audit", async () => {
      const { deletePermission } = await import("../permissions.server");
      const existing = {
        ...mockPermission,
    ...
    it("throws PermissionError when permission not found", async () => {
      const { deletePermission, PermissionError } = await import("../permissions.server");
      mockPermissionFindFirst.mockResolvedValue(null);
  ...
  describe("PermissionError", () => {
    it("is an instance of ServiceError", async () => {
      const { PermissionError } = await import("../permissions.server");
