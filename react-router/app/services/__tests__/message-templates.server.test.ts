...
describe("message-templates.server", () => {
  ...
  describe("listTemplatesPaginated", () => {
    it("returns paginated items and totalCount", async () => {
      const { listTemplatesPaginated } = await import("../message-templates.server");
  ...
  describe("getTemplate", () => {
    ...
    it("throws TemplateError when not found", async () => {
      const { getTemplate, TemplateError } = await import("../message-templates.server");
  ...
  describe("updateTemplate", () => {
    ...
    it("throws TemplateError when template not found", async () => {
      const { updateTemplate, TemplateError } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue(null);
  ...
  describe("deleteTemplate", () => {
    ...
    it("throws TemplateError when template not found", async () => {
      const { deleteTemplate, TemplateError } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue(null);
  ...
  describe("cloneTemplate", () => {
    it("clones an existing template with a new name", async () => {
      const { cloneTemplate } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue({ ...baseTemplate });
    ...
    it("throws TemplateError when source template not found", async () => {
      const { cloneTemplate, TemplateError } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue(null);
  ...
  describe("previewTemplate", () => {
    it("previews a template with sample data", async () => {
      const { previewTemplate } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue({ ...baseTemplate });
    ...
    it("throws TemplateError when template not found", async () => {
      const { previewTemplate, TemplateError } = await import("../message-templates.server");
      mockTemplateFindFirst.mockResolvedValue(null);
  ...
  describe("TemplateError", () => {
    it("has correct default properties", async () => {
      const { TemplateError } = await import("../message-templates.server");
