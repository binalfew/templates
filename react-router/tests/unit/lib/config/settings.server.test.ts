...
describe("settings.server", () => {
  ...
  describe("SETTING_DEFAULTS", () => {
    it("exports defaults for all expected settings", async () => {
      const { SETTING_DEFAULTS } = await import("~/lib/config/settings.server");
  ...
  describe("getSetting", () => {
    it("returns database setting when found at global scope", async () => {
      ...
      const { getSetting } = await import("~/lib/config/settings.server");
  ...
  describe("setSetting", () => {
    it("upserts the setting and creates an audit log", async () => {
      ...
      const { setSetting } = await import("~/lib/config/settings.server");
  ...
  describe("getSettingsByCategory", () => {
    it("returns all settings for a category with scope resolution", async () => {
      ...
      const { getSettingsByCategory } = await import("~/lib/config/settings.server");
  ...
  describe("getAllSettings", () => {
    it("returns settings grouped by category", async () => {
      ...
      const { getAllSettings } = await import("~/lib/config/settings.server");
  ...
  describe("deleteSetting", () => {
    it("deletes a setting and returns success true", async () => {
      ...
      const { deleteSetting } = await import("~/lib/config/settings.server");
