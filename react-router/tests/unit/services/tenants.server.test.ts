...
describe("tenants.server", () => {
  ...
  describe("listTenants", () => {
    it("lists all tenants excluding admin", async () => {
      const { listTenants } = await import("~/services/tenants.server");
      const mockTenants = [
  ...
  describe("listTenantsPaginated", () => {
    it("returns paginated tenants with totalCount", async () => {
      const { listTenantsPaginated } = await import("~/services/tenants.server");
      const mockTenants = [
  ...
  describe("getTenant", () => {
    it("returns a tenant by id", async () => {
      const { getTenant } = await import("~/services/tenants.server");
    ...
    it("throws TenantError when not found", async () => {
      const { getTenant, TenantError } = await import("~/services/tenants.server");
  ...
  describe("getTenantBySlug", () => {
    it("returns a tenant by slug", async () => {
      const { getTenantBySlug } = await import("~/services/tenants.server");
      const mockTenant = { id: "t-1", name: "Acme Corp", slug: "acme" };
      mockTenantFindFirst.mockResolvedValue(mockTenant);
    ...
    it("throws TenantError when not found", async () => {
      const { getTenantBySlug, TenantError } = await import("~/services/tenants.server");
      mockTenantFindFirst.mockResolvedValue(null);
  ...
  describe("getTenantWithCounts", () => {
    it("returns a tenant with user and role counts", async () => {
      const { getTenantWithCounts } = await import("~/services/tenants.server");
      const mockTenant = {
        id: "t-1",
        name: "Acme Corp",
    ...
    it("throws TenantError when not found", async () => {
      const { getTenantWithCounts, TenantError } = await import("~/services/tenants.server");
      mockTenantFindFirst.mockResolvedValue(null);
  ...
  describe("getTenantDetail", () => {
    it("returns a tenant detail wrapped in { tenant }", async () => {
      const { getTenantDetail } = await import("~/services/tenants.server");
      const mockTenant = {
        id: "t-1",
        name: "Acme Corp",
        _count: { users: 10, roles: 5 },
    ...
    it("throws TenantError when not found", async () => {
      const { getTenantDetail, TenantError } = await import("~/services/tenants.server");
      mockTenantFindFirst.mockResolvedValue(null);
  ...
  describe("createTenant", () => {
    ...
    it("creates a tenant with default roles and audit log", async () => {
      const { createTenant } = await import("~/services/tenants.server");
    ...
    it("throws TenantError on duplicate name/email (P2002)", async () => {
      const { createTenant, TenantError } = await import("~/services/tenants.server");
  ...
  describe("updateTenant", () => {
    ...
    it("updates a tenant and creates audit log", async () => {
      const { updateTenant } = await import("~/services/tenants.server");
    ...
    it("throws TenantError when tenant not found", async () => {
      const { updateTenant, TenantError } = await import("~/services/tenants.server");
      mockTenantFindFirst.mockResolvedValue(null);
  ...
  describe("deleteTenant", () => {
    it("hard-deletes a tenant with no users and creates audit log", async () => {
      const { deleteTenant } = await import("~/services/tenants.server");
    ...
    it("throws TenantError when tenant not found", async () => {
      const { deleteTenant, TenantError } = await import("~/services/tenants.server");
      mockTenantFindFirst.mockResolvedValue(null);
