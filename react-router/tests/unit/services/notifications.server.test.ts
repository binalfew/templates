...
describe("notifications.server", () => {
  ...
  describe("getUnreadCount", () => {
    it("returns the count of unread notifications", async () => {
      const { getUnreadCount } = await import("~/services/notifications.server");
  ...
  describe("markAsRead", () => {
    it("marks a single notification as read", async () => {
      const { markAsRead } = await import("~/services/notifications.server");
      const now = new Date();
  ...
  describe("markAllAsRead", () => {
    it("marks all unread notifications as read for the user", async () => {
      const { markAllAsRead } = await import("~/services/notifications.server");
  ...
  describe("deleteNotification", () => {
    it("deletes a notification by id and userId", async () => {
      const { deleteNotification } = await import("~/services/notifications.server");
