...
describe("reference-data.server", () => {
  ...
  describe("listCountries", () => {
    it("returns all countries without filter", async () => {
      const { listCountries } = await import("~/services/reference-data.server");
      const countries = [
  ...
  describe("listCountriesPaginated", () => {
    it("returns paginated results with defaults", async () => {
      const { listCountriesPaginated } = await import("~/services/reference-data.server");
  ...
  describe("getCountry", () => {
    it("returns a country by id", async () => {
      const { getCountry } = await import("~/services/reference-data.server");
    ...
    it("throws ReferenceDataError when not found", async () => {
      const { getCountry, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("createCountry", () => {
    it("creates a country and writes audit log", async () => {
      const { createCountry } = await import("~/services/reference-data.server");
    ...
    it("throws 409 on duplicate code", async () => {
      const { createCountry, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("updateCountry", () => {
    it("updates an existing country and writes audit", async () => {
      const { updateCountry } = await import("~/services/reference-data.server");
    ...
    it("throws 404 when country not found", async () => {
      const { updateCountry, ReferenceDataError } = await import("~/services/reference-data.server");
      mockCountryFindFirst.mockResolvedValue(null);
  ...
  describe("deleteCountry", () => {
    it("deletes a country and writes audit", async () => {
      const { deleteCountry } = await import("~/services/reference-data.server");
      mockCountryFindFirst.mockResolvedValue({ id: "c-1", code: "US", name: "United States" });
    ...
    it("throws 404 when country not found", async () => {
      const { deleteCountry, ReferenceDataError } = await import("~/services/reference-data.server");
      mockCountryFindFirst.mockResolvedValue(null);
  ...
  describe("listTitles", () => {
    it("returns all titles without filter", async () => {
      const { listTitles } = await import("~/services/reference-data.server");
      const titles = [
  ...
  describe("listTitlesPaginated", () => {
    it("returns paginated titles", async () => {
      const { listTitlesPaginated } = await import("~/services/reference-data.server");
  ...
  describe("getTitle", () => {
    it("returns a title by id", async () => {
      const { getTitle } = await import("~/services/reference-data.server");
    ...
    it("throws when title not found", async () => {
      const { getTitle, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("createTitle", () => {
    it("creates a title and writes audit log", async () => {
      const { createTitle } = await import("~/services/reference-data.server");
    ...
    it("throws 409 on duplicate code", async () => {
      const { createTitle, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("updateTitle", () => {
    it("updates an existing title", async () => {
      const { updateTitle } = await import("~/services/reference-data.server");
    ...
    it("throws 404 when title not found", async () => {
      const { updateTitle, ReferenceDataError } = await import("~/services/reference-data.server");
      mockTitleFindFirst.mockResolvedValue(null);
  ...
  describe("deleteTitle", () => {
    it("deletes a title and writes audit", async () => {
      const { deleteTitle } = await import("~/services/reference-data.server");
      mockTitleFindFirst.mockResolvedValue({ id: "t-1", code: "MR", name: "Mr." });
    ...
    it("throws 404 when title not found", async () => {
      const { deleteTitle, ReferenceDataError } = await import("~/services/reference-data.server");
      mockTitleFindFirst.mockResolvedValue(null);
  ...
  describe("listLanguages", () => {
    it("returns all languages without filter", async () => {
      const { listLanguages } = await import("~/services/reference-data.server");
      const languages = [
  ...
  describe("listLanguagesPaginated", () => {
    it("returns paginated languages", async () => {
      const { listLanguagesPaginated } = await import("~/services/reference-data.server");
  ...
  describe("getLanguage", () => {
    it("returns a language by id", async () => {
      const { getLanguage } = await import("~/services/reference-data.server");
    ...
    it("throws when language not found", async () => {
      const { getLanguage, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("createLanguage", () => {
    it("creates a language with lowercased code", async () => {
      const { createLanguage } = await import("~/services/reference-data.server");
    ...
    it("throws 409 on duplicate code", async () => {
      const { createLanguage, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("updateLanguage", () => {
    it("updates an existing language", async () => {
      const { updateLanguage } = await import("~/services/reference-data.server");
    ...
    it("throws 404 when language not found", async () => {
      const { updateLanguage, ReferenceDataError } = await import("~/services/reference-data.server");
      mockLanguageFindFirst.mockResolvedValue(null);
  ...
  describe("deleteLanguage", () => {
    it("deletes a language and writes audit", async () => {
      const { deleteLanguage } = await import("~/services/reference-data.server");
      mockLanguageFindFirst.mockResolvedValue({ id: "l-1", code: "en", name: "English" });
    ...
    it("throws 404 when language not found", async () => {
      const { deleteLanguage, ReferenceDataError } = await import("~/services/reference-data.server");
      mockLanguageFindFirst.mockResolvedValue(null);
  ...
  describe("listCurrencies", () => {
    it("returns all currencies without filter", async () => {
      const { listCurrencies } = await import("~/services/reference-data.server");
      const currencies = [
  ...
  describe("listCurrenciesPaginated", () => {
    it("returns paginated currencies", async () => {
      const { listCurrenciesPaginated } = await import("~/services/reference-data.server");
  ...
  describe("getCurrency", () => {
    it("returns a currency by id", async () => {
      const { getCurrency } = await import("~/services/reference-data.server");
    ...
    it("throws when currency not found", async () => {
      const { getCurrency, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("createCurrency", () => {
    it("creates a currency with uppercased code and audit", async () => {
      const { createCurrency } = await import("~/services/reference-data.server");
    ...
    it("throws 409 on duplicate code", async () => {
      const { createCurrency, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("updateCurrency", () => {
    it("updates an existing currency", async () => {
      const { updateCurrency } = await import("~/services/reference-data.server");
    ...
    it("throws 404 when currency not found", async () => {
      const { updateCurrency, ReferenceDataError } = await import("~/services/reference-data.server");
      mockCurrencyFindFirst.mockResolvedValue(null);
  ...
  describe("deleteCurrency", () => {
    it("deletes a currency and writes audit", async () => {
      const { deleteCurrency } = await import("~/services/reference-data.server");
      mockCurrencyFindFirst.mockResolvedValue({ id: "cur-1", code: "USD", name: "US Dollar" });
    ...
    it("throws 404 when currency not found", async () => {
      const { deleteCurrency, ReferenceDataError } = await import("~/services/reference-data.server");
      mockCurrencyFindFirst.mockResolvedValue(null);
  ...
  describe("listDocumentTypes", () => {
    it("returns all document types without filter", async () => {
      const { listDocumentTypes } = await import("~/services/reference-data.server");
      const docTypes = [
  ...
  describe("listDocumentTypesPaginated", () => {
    it("returns paginated document types", async () => {
      const { listDocumentTypesPaginated } = await import("~/services/reference-data.server");
  ...
  describe("getDocumentType", () => {
    it("returns a document type by id", async () => {
      const { getDocumentType } = await import("~/services/reference-data.server");
    ...
    it("throws when document type not found", async () => {
      const { getDocumentType, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("createDocumentType", () => {
    it("creates a document type with uppercased code and audit", async () => {
      const { createDocumentType } = await import("~/services/reference-data.server");
    ...
    it("throws 409 on duplicate code", async () => {
      const { createDocumentType, ReferenceDataError } = await import("~/services/reference-data.server");
  ...
  describe("updateDocumentType", () => {
    it("updates an existing document type", async () => {
      const { updateDocumentType } = await import("~/services/reference-data.server");
    ...
    it("throws 404 when document type not found", async () => {
      const { updateDocumentType, ReferenceDataError } = await import("~/services/reference-data.server");
      mockDocTypeFindFirst.mockResolvedValue(null);
  ...
  describe("deleteDocumentType", () => {
    it("deletes a document type and writes audit", async () => {
      const { deleteDocumentType } = await import("~/services/reference-data.server");
      mockDocTypeFindFirst.mockResolvedValue({ id: "dt-1", code: "PASSPORT", name: "Passport" });
    ...
    it("throws 404 when document type not found", async () => {
      const { deleteDocumentType, ReferenceDataError } = await import("~/services/reference-data.server");
      mockDocTypeFindFirst.mockResolvedValue(null);
  ...
  describe("getReferenceDataCounts", () => {
    it("returns counts for all entity types", async () => {
      const { getReferenceDataCounts } = await import("~/services/reference-data.server");
  ...
  describe("ReferenceDataError", () => {
    it("extends ServiceError with name and status", async () => {
      const { ReferenceDataError } = await import("~/services/reference-data.server");
