...
describe("roles.server", () => {
  ...
  describe("listRoles", () => {
    it("lists roles for a tenant with default ordering", async () => {
      const { listRoles } = await import("~/services/roles.server");
      const roles = [
  ...
  describe("listRolesPaginated", () => {
    it("returns paginated results with default ordering", async () => {
      const { listRolesPaginated } = await import("~/services/roles.server");
  ...
  describe("getRole", () => {
    it("returns a role with permissions by id and tenantId", async () => {
      const { getRole } = await import("~/services/roles.server");
    ...
    it("throws RoleError when not found", async () => {
      const { getRole, RoleError } = await import("~/services/roles.server");
  ...
  describe("getRoleWithCounts", () => {
    it("returns a role with user and permission counts", async () => {
      const { getRoleWithCounts } = await import("~/services/roles.server");
    ...
    it("throws RoleError when not found", async () => {
      const { getRoleWithCounts, RoleError } = await import("~/services/roles.server");
      mockRoleFindFirst.mockResolvedValue(null);
  ...
  describe("createRole", () => {
    it("creates a role and logs an audit entry", async () => {
      const { createRole } = await import("~/services/roles.server");
      const created = {
        id: "role-new",
        tenantId: "tenant-1",
        name: "Moderator",
    ...
    it("throws RoleError on duplicate name (P2002)", async () => {
      const { createRole, RoleError } = await import("~/services/roles.server");
  ...
  describe("updateRole", () => {
    it("updates a role name and description, and logs audit", async () => {
      const { updateRole } = await import("~/services/roles.server");
    ...
    it("throws RoleError when role not found", async () => {
      const { updateRole, RoleError } = await import("~/services/roles.server");
      mockRoleFindFirst.mockResolvedValue(null);
  ...
  describe("deleteRole", () => {
    it("soft-deletes a role with no assigned users and logs audit", async () => {
      const { deleteRole } = await import("~/services/roles.server");
      const existing = {
        ...mockRole,
    ...
    it("throws RoleError when role not found", async () => {
      const { deleteRole, RoleError } = await import("~/services/roles.server");
      mockRoleFindFirst.mockResolvedValue(null);
  ...
  describe("assignPermissions", () => {
    it("replaces all permissions for a role and logs audit", async () => {
      const { assignPermissions } = await import("~/services/roles.server");
      mockRoleFindFirst.mockResolvedValue(mockRole);
    ...
    it("throws RoleError when role not found", async () => {
      const { assignPermissions, RoleError } = await import("~/services/roles.server");
      mockRoleFindFirst.mockResolvedValue(null);
  ...
  describe("RoleError", () => {
    it("is an instance of ServiceError", async () => {
      const { RoleError } = await import("~/services/roles.server");
