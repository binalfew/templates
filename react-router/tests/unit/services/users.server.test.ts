...
describe("users.server", () => {
  ...
  describe("listUsers", () => {
    it("lists users for a specific tenant", async () => {
      const { listUsers } = await import("~/services/users.server");
      const mockUsers = [
  ...
  describe("listUsersPaginated", () => {
    it("returns paginated users with totalCount", async () => {
      const { listUsersPaginated } = await import("~/services/users.server");
  ...
  describe("getUser", () => {
    it("returns a user by id", async () => {
      const { getUser } = await import("~/services/users.server");
      const mockUser = {
        id: "u-1",
    ...
    it("throws UserError when user not found", async () => {
      const { getUser, UserError } = await import("~/services/users.server");
  ...
  describe("getUserWithCounts", () => {
    it("returns a user with session and role counts", async () => {
      const { getUserWithCounts } = await import("~/services/users.server");
      const mockUser = {
        id: "u-1",
        email: "alice@example.com",
        userRoles: [],
    ...
    it("throws UserError when user not found", async () => {
      const { getUserWithCounts, UserError } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue(null);
  ...
  describe("createUser", () => {
    it("creates a user with hashed password and audit log", async () => {
      const { createUser } = await import("~/services/users.server");
      const createdUser = {
        id: "u-new",
    ...
    it("throws UserError on duplicate email/username (P2002)", async () => {
      const { createUser, UserError } = await import("~/services/users.server");
  ...
  describe("updateUser", () => {
    it("updates a user and creates audit log", async () => {
      const { updateUser } = await import("~/services/users.server");
      const existingUser = {
        id: "u-1",
    ...
    it("throws UserError when user not found", async () => {
      const { updateUser, UserError } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue(null);
  ...
  describe("deleteUser", () => {
    it("soft-deletes a user and creates audit log", async () => {
      const { deleteUser } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue({
        id: "u-1",
        email: "alice@example.com",
        username: "alice",
    ...
    it("throws UserError when user not found", async () => {
      const { deleteUser, UserError } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue(null);
  ...
  describe("changePassword", () => {
    it("upserts the password hash and creates audit log", async () => {
      const { changePassword } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue({
        id: "u-1",
        email: "alice@example.com",
      });
    ...
    it("throws UserError when user not found", async () => {
      const { changePassword, UserError } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue(null);
  ...
  describe("assignRoles", () => {
    it("replaces existing roles with new ones and creates audit log", async () => {
      const { assignRoles } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue({
        id: "u-1",
        email: "alice@example.com",
      });
    ...
    it("throws UserError when user not found", async () => {
      const { assignRoles, UserError } = await import("~/services/users.server");
      mockUserFindFirst.mockResolvedValue(null);
  ...
  describe("getUserRoles", () => {
    it("returns user roles excluding event-scoped ones", async () => {
      const { getUserRoles } = await import("~/services/users.server");
      const mockRoles = [
