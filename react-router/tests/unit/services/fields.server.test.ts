...
describe("fields.server", () => {
  ...
  describe("listFields", () => {
    it("lists all fields for a tenant with no filters", async () => {
      const { listFields } = await import("~/services/fields.server");
  ...
  describe("listFieldsPaginated", () => {
    it("returns paginated items and totalCount", async () => {
      const { listFieldsPaginated } = await import("~/services/fields.server");
      mockFieldFindMany.mockResolvedValue([sampleField]);
  ...
  describe("createField", () => {
    ...
    it("creates a field with auto-calculated sortOrder", async () => {
      const { createField } = await import("~/services/fields.server");
    ...
    it("throws FieldError when tenant limit is reached", async () => {
      const { createField, FieldError } = await import("~/services/fields.server");
  ...
  describe("updateField", () => {
    ...
    it("updates a field successfully", async () => {
      const { updateField } = await import("~/services/fields.server");
    ...
    it("throws FieldError when field not found", async () => {
      const { updateField, FieldError } = await import("~/services/fields.server");
  ...
  describe("deleteField", () => {
    it("deletes a field with no data", async () => {
      const { deleteField } = await import("~/services/fields.server");
    ...
    it("throws FieldError when field not found", async () => {
      const { deleteField, FieldError } = await import("~/services/fields.server");
  ...
  describe("reorderFields", () => {
    it("reorders fields in a transaction", async () => {
      const { reorderFields } = await import("~/services/fields.server");
    ...
    it("throws FieldError when some fields are not found", async () => {
      const { reorderFields, FieldError } = await import("~/services/fields.server");
  ...
  describe("getField", () => {
    it("returns the field when found", async () => {
      const { getField } = await import("~/services/fields.server");
    ...
    it("throws FieldError when not found", async () => {
      const { getField, FieldError } = await import("~/services/fields.server");
  ...
  describe("getFieldDataCount", () => {
    it("returns count from raw query", async () => {
      const { getFieldDataCount } = await import("~/services/fields.server");
  ...
  describe("getEffectiveFields", () => {
    it("returns fields for a given tenant and entity type", async () => {
      const { getEffectiveFields } = await import("~/services/fields.server");
